...
notebooks_url = "https://github.com/single-cell-genetics/XClone/tree/devHKU/examples/"
notebooks = [
    "TNBC1_XClone_demo_v1.ipynb",
    "BCH869_XClone_demo_v1.ipynb"
]
# for nb in notebooks:
#     try:
...
import xclone
version = xclone.__version__ #'0.3.0' #
...
latex_documents = [
  ('index', 'XClone.tex', u'XClone Documentation',
   u'Rongting Huang', 'manual'),
]
